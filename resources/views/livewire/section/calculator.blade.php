                ...
                <div class="calculator-form__section-body">
                    ...
                    <div class="calculator-form__section-group">
                        <div class="calculator-form__field field">
                            ...
                            <input type="number" step="0.01" class="field__text" wire:model.lazy="gasPrice"
                                placeholder="9.00" wire:change="calculateElectricityCost">
                        </div>
                    </div>
                ...
                <div class="calculator-form__section-body">
                    <div class="calculator-form__section-group">
                        <div class="calculator-form__field field">
                            ...
                            <input type="text" class="field__text" placeholder="Андрей Иванов">
                        </div>
                        <div class="calculator-form__field field">
                            <div class="field__label">Ваш телефон</div>
                            <input type="tel" class="field__text" placeholder="+7 (999) 999-99-99">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="calculator-form__section">
                ...
                <div class="calculator-form__section-body">
                    ...
                    <div class="calculator-form__field field">
                        ...
                        <small>{{ $electricityCost ? 'Стоимость: ' . number_format($electricityCost, 2) . ' руб' : 'Заполните данные' }}</small>
                    </div>
                    ...
                    <div class="calculator-form__field field">
                        ...
                        <small>{{ $totalCost ? 'Стоимость: ' . number_format($totalCost, 2) . ' руб' : 'Заполните данные' }}</small>
                    </div>

                    <div class="calculator-form__field field">
                        <div class="field__label">Срок окупаемости</div>
                        <input type="text" class="field__text" readonly
                            value="@if($paybackMonths > 0) {{ $paybackMonths }} {{ trans_choice('месяц|месяца|месяцев', $paybackMonths) }} @endif
                        @if($paybackWeeks > 0) {{ $paybackWeeks }} {{ trans_choice('неделя|недели|недель', $paybackWeeks) }} @endif">
