<div class="modal modal--callback-product" id="modal-contact" wire:ignore.self data-modal-path="modal-contact">
    <div class="modal__overlay">
        <div class="modal__wrapper">
            <button class="modal__close-btn" data-modal-close><i class="ri-close-line"></i></button>
            <div class="modal__header">
                <div class="modal__header-label h4">Заказать обратный звонок</div>
            </div>
